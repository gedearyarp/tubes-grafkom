...
function getPoints(event){
    ...
    var x = (event.clientX-(canvasOffset.left)-(canvas.width/2)) / (canvas.width/2);
    var y = (1-(event.clientY-(canvasOffset.top)-(canvas.height/2))) / (canvas.height/2); 
    ...
    console.log(x,y);
    console.log(shapeData[vertexId].vertices[vertexNum],shapeData[vertexId].vertices[vertexNum+1]);
